    ...
    render() {
        ...
        return <Provider store={store}>
            <Fragment>
                ...
                {/*<div id='all' className={currentIndex === 1 ? '':'hide'}>{all}</div>*/}
                {/*<div id='todo' className={currentIndex === 2 ? '':'hide'}>{pass}</div>*/}
                {/*<div id='done' className={currentIndex === 3 ? '':'hide'}>{unpass}</div>*/}
            </Fragment>
        </Provider>
    }
}
